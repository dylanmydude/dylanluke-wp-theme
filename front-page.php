    ...
    <section class="about" id="about">
        <div class="about-content">
            <div class="about-text">
                ...
                <a href="#contact" class="hero-button-wrapper">
                    <button class="hero-button">Learn more</button>
                </a>
            </div>
            <div class="about-image">
                <img class="slide-in-right" src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-image.jpg" alt="About Image">
            </div>
        </div>
    </section>
    ...
    <section class="contact" id="contact">
        <div class="contact-content">
            ...
            <div class="contact-image">
                <img class="slide-in-left" src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-image.jpg" alt="Contact Image">
            </div>
